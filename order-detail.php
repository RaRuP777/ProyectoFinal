        ...
        <div class="container" style="max-width:760px;">
            <div class="card" style="padding:2.5rem;text-align:center;border-radius:24px;">
                ...
                <div style="display:flex;gap:.75rem;justify-content:center;flex-wrap:wrap;">
                    <a href="my-orders.php" class="btn btn-primary">Volver a mis pedidos</a>
                    <a href="index.php#menu" class="btn btn-outline">Ir al menú</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <div style="display:flex;justify-content:space-between;gap:1rem;align-items:flex-start;flex-wrap:wrap;">
            ...
            <div style="display:flex;gap:.75rem;flex-wrap:wrap;">
                <a href="my-orders.php" class="btn btn-outline" style="background:#fff;color:#FF6B35;border-color:#fff;">← Mis pedidos</a>
                <a href="index.php#menu" class="btn btn-outline" style="border-color:rgba(255,255,255,.45);color:#fff;">Ver menú</a>
            </div>
        </div>
    </div>
</section>
                ...
                <?php else: ?>
                    <div class="order-items-list">
                        <?php foreach ($order_items as $item): ?>
                            ...
                            $image_url = $image !== '' ? 'uploads/products/' . ltrim($image, '/')) : '';
                            ?>
        ...
        <aside class="order-side-column">
            <div class="order-card sticky-card">
                ...
                <div class="side-actions">
                    <a href="my-orders.php" class="btn btn-outline">← Volver</a>
                    <?php if ($can_repeat): ?>
                        <a href="index.php#menu" class="btn btn-primary">🔄 Pedir de nuevo</a>
                    <?php endif; ?>
                </div>
            </div>
        </aside>
